...
SFLAG1     is the source flag for the first day of the month.  There are 
	   ...
	   lower case letters):
           ...
           1     = CF6 (form F6) daily climate summaries from the U.S.
                   National Weather Service
           2     = Synoptic Summary of the Day (SSOD) "version 2", the 
                   successor to GSOD (source 'S')
	   ...
	   Z,R,W,D,d,1,0,6,C,X,K,7,F,B,M,f,m,r,E,z,u,b,s,a,G,Q,I,A,N,T,U,H,2,S
